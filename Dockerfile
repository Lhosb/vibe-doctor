...
# docker build -t vibe_doctor .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name vibe_doctor vibe_doctor
...
# Runtime toolchain for EnrichAlbumJob's audio grounding (Sonance shells out to
